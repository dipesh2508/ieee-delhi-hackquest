...
const ScrollNavBar = () => {
  ...
  return (
    <nav className=" py-6 bg-dark text-primary border-b-2 border-primary">
      <div className="mx-auto flex max-h-96 max-w-screen-xl flex-wrap align-middle my-auto items-center justify-between px-2 md:px-0">
        ...
        <div className="hidden w-full md:block md:w-auto" id="navbar-default">
          <ul className="mt-4 flex flex-col p-4 font-medium md:mt-0 md:flex-row md:space-x-8 md:p-0 ">
            {navLinks.map((nav, key) => (
              ...
              <Link href="/register">
                <Button  className="hidden rounded-full px-6 md:block">Register</Button>
              </Link>
          </ul>
        </div>
      </div>
